...
// @author       You
// @match        https://*/docserver2_fwk/swagger/dist/index.html
// @match        https://*/*/docserver2_fwk/swagger/dist/index.html
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    function main() {
        ...
        var observer = new MutationObserver(function(){
            ...
            typeInElement(inputUser, "118562E");
            var inputPass = document.querySelector('#myPassword');
            if (!inputPass) {
                return;
            }
            var passValue = (/localhost/i.test(window.location.href)) ? "password" : "dPkZ8Yif";
